...
def get_parser():
    ...
    parser.add_argument('--type', default="rect", choices=['point', 'rect'], help='type')
...
if __name__ == "__main__":
    ...
    print(classification_report(y_true, y_pred, labels=range(len(CHARS)), target_names=CHARS))

    matrixes = confusion_matrix(y_true, y_pred, labels=range(len(CHARS)))

    disp = ConfusionMatrixDisplay(confusion_matrix=matrixes, display_labels=CHARS)
    disp.plot(
