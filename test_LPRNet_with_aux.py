...
from model.LPRNet import build_lprnet_with_aux as build_lprnet
...
def get_parser():
    ...
    parser.add_argument('--pretrained_model', default='./aux/Final_LPRNet_model.pth', help='pretrained base model')
